    ...
    public void setRecommendations(Utente user,  MainPagesController mainPagesController) {
        try {
            ...
            for (Content c:contentList.getFirst()) {
                FXMLLoader loader = new FXMLLoader(getClass().getResource(mainPagesController.pathWindowCard),mainPagesController.resourceBundle);
            ...
            ScrollView top10Scroll = new ScrollView("Chosen for you:", Color.TRANSPARENT, mainPagesController.foreColor, mainPagesController.backgroundColor);
            top10Scroll.setContent(mainPagesController.createFilmNodes(contentList.get(1), false));


            ScrollView latest10Scroll = new ScrollView("New Releases:", Color.rgb(228, 193, 42), mainPagesController.backgroundColor, null, 32.0);
            latest10Scroll.setContent(mainPagesController.createFilmNodes( contentList.get(2), true));


            ScrollView favouriteCategoryScroll = new ScrollView("We think you'll like them:", Color.TRANSPARENT, mainPagesController.foreColor, mainPagesController.backgroundColor);
            ...
            if(!contentList.get(4).isEmpty()) {
                ScrollView similarToLastWatchedScroll = new ScrollView("Similar at " + contentList.get(4).getFirst().getTitle() + " :", Color.TRANSPARENT, mainPagesController.foreColor, mainPagesController.backgroundColor);
                similarToLastWatchedScroll.setContent(mainPagesController.createFilmNodes(contentList.get(4), false));
            }

            ScrollView recommendSeriesScroll = new ScrollView("Series that you may like:", Color.TRANSPARENT, mainPagesController.foreColor, mainPagesController.backgroundColor);
            recommendSeriesScroll.setContent(mainPagesController.createFilmNodes( contentList.get(6), true));



            ScrollView bottom7Scroll = new ScrollView("New Experiences:", Color.TRANSPARENT, mainPagesController.foreColor, mainPagesController.backgroundColor);
            ...
            if (!contentList.get(5).isEmpty()) {
                ScrollView watchedScroll =new ScrollView("Continue to watch:", Color.TRANSPARENT, mainPagesController.foreColor, mainPagesController.backgroundColor, 32.0);
            ...
            if (!contentList.get(7).isEmpty()) {
                ScrollView favouriteScroll = new ScrollView("Favourites:", Color.rgb(155, 155, 155), mainPagesController.backgroundColor, null, 32.0);
